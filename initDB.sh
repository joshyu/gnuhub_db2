...
db2 "CREATE USER TEMPORARY TABLESPACE SYSTOOLSTMPSPACE IN IBMCATGROUP MANAGED BY AUTOMATIC STORAGE EXTENTSIZE 4"

db2ts DISABLE DATABASE FOR TEXT CONNECT TO ${1}
## 
db2ts ENABLE DATABASE FOR TEXT AUTOGRANT CONNECT TO ${1}
#db2ts ENABLE DATABASE FOR TEXT CONNECT TO ${1} USER db2inst1 USING 111111
